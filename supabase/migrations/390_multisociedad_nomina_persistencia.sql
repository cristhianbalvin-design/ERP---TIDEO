-- TIDEO ERP - Persistencia de nomina por sociedad.
-- La funcion legacy permanece disponible para periodos con sociedad_id NULL.
...
begin
  ...
  insert into public.nomina_detalle (
    ...
    aporte_afp, comision_afp_flujo, prima_seguro_afp, desc_onp,
