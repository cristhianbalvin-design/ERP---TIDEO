-- Centraliza el tipo de recepción y el estado/porcentaje de la OC.
-- No recalcula datos históricos por sí sola: solo actúa sobre la recepción
-- explícitamente indicada por cada nuevo registro de recepción.
...
begin
  ...
  v_estado := case when v_porcentaje >= 100 then 'cerrada' else 'recibida_parcial' end;
  v_lead_time := case
