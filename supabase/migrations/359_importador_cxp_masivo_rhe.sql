-- Extiende el importador masivo de CxP con RHE externo e interno.
-- La rama de proveedores de la migracion 358 se conserva sin cambios funcionales.
...
begin
  ...
  insert into public.cxp (
    id, empresa_id, proveedor_id, tipo_beneficiario, personal_id, factura_numero, concepto,
    ...
    v_cxp_id, v_empresa_id, case when v_es_rhe then null else v_proveedor_id end,
  ...
  insert into public.compras_gastos (
    ...
    v_gasto_id, v_empresa_id, 'gasto', v_concepto, v_categoria_er,
