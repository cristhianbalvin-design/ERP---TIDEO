-- TIDEO ERP - Impide sobrescribir snapshots de nómina de períodos terminales.
-- El cierre ya genera gastos y CxP; por ello los estados cerrado y anulado
-- no pueden volver a procesarse mediante las RPC de persistencia.
