-- Motor atómico de inventario: kardex, stock y costo promedio se confirman
-- como una sola transacción. El stock se bloquea por material/almacén/lote/
-- serie/sociedad antes de validar o calcular el nuevo saldo.
...
begin
  ...
  insert into public.kardex (
    ...
    moneda, lote, serie, vencimiento, saldo_cantidad, referencia_tipo,
    ...
    v_costo_unitario * p_cantidad, coalesce(p_costo_unitario_usd, 0),
    coalesce(p_costo_unitario_usd, 0) * p_cantidad, coalesce(p_moneda, 'PEN'),
