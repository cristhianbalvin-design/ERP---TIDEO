-- Restauracion de bloques perdidos de generar_cxp_centralizado.
-- Fuente base: pg_get_functiondef(public.generar_cxp_centralizado), oid 234062,
-- verificada el 2026-09-24. No recrea indices ni otras funciones.
