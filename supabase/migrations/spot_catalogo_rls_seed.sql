...
-- Catálogo global SUNAT, lectura para tenants y seed verificado.
-- No incluye bienes del Anexo 1 ni códigos reubicados por la RS 086-2025/SUNAT.
...
begin
  if exists (
    ...
    raise exception 'El código SPOT % tiene vigencias superpuestas.', new.codigo;
  end if;
...
comment on table public.spot_catalogo is
  'Catálogo global versionado de códigos SPOT. Los tenants autenticados solo pueden leerlo.';
...
comment on column public.spot_catalogo.fuente_referencia is
  'Resolución, fecha o nota de verificación utilizada para esta fila.';
...
values
  ('004', 'ANEXO_2', '4',  'Recursos hidrobiológicos', 4.00, 700.00, '>', '2015-01-01',
   'https://orientacion.sunat.gob.pe/apendices-del-sistema-de-detracciones',
   'Apéndice oficial SUNAT consultado el 2026-09-23; tasa vigente desde 2015-01-01.'),
  ('005', 'ANEXO_2', '5',  'Maíz amarillo duro', 4.00, 700.00, '>', '2015-01-01',
   'https://orientacion.sunat.gob.pe/apendices-del-sistema-de-detracciones',
   'Apéndice oficial SUNAT consultado el 2026-09-23; tasa vigente desde 2015-01-01.'),
  ('007', 'ANEXO_2', '7',  'Caña de azúcar', 10.00, 700.00, '>', '2017-10-16',
   'https://www.sunat.gob.pe/legislacion/superin/2017/246-2017.pdf',
   'RS 246-2017/SUNAT; vigencia de tasa desde 2017-10-16.'),
  ('008', 'ANEXO_2', '8',  'Madera', 4.00, 700.00, '>', '2015-01-01',
   'https://orientacion.sunat.gob.pe/apendices-del-sistema-de-detracciones',
   'Apéndice oficial SUNAT consultado el 2026-09-23; tasa vigente desde 2015-01-01.'),
  ('009', 'ANEXO_2', '9',  'Arena y piedra', 10.00, 700.00, '>', '2015-01-01',
   'https://orientacion.sunat.gob.pe/apendices-del-sistema-de-detracciones',
   'Apéndice oficial SUNAT consultado el 2026-09-23; tasa vigente desde 2015-01-01.'),
  ('010', 'ANEXO_2', '10', 'Residuos y subproductos', 15.00, 700.00, '>', '2015-01-01',
   'https://orientacion.sunat.gob.pe/apendices-del-sistema-de-detracciones',
   'Apéndice oficial SUNAT consultado el 2026-09-23; tasa vigente desde 2015-01-01.'),
  ('011', 'ANEXO_2', '11', 'Bienes gravados por renuncia a la exoneración', 10.00, 700.00, '>', '2018-04-01',
   'https://orientacion.sunat.gob.pe/apendices-del-sistema-de-detracciones',
   'Apéndice oficial SUNAT consultado el 2026-09-23; tasa vigente desde 2018-04-01.'),
  ('014', 'ANEXO_2', '14', 'Carnes y despojos comestibles', 4.00, 700.00, '>', '2015-01-01',
   'https://orientacion.sunat.gob.pe/apendices-del-sistema-de-detracciones',
   'Apéndice oficial SUNAT consultado el 2026-09-23; tasa vigente desde 2015-01-01.'),
  ('016', 'ANEXO_2', '16', 'Aceite de pescado', 10.00, 700.00, '>', '2018-04-01',
   'https://orientacion.sunat.gob.pe/apendices-del-sistema-de-detracciones',
   'Apéndice oficial SUNAT consultado el 2026-09-23; tasa vigente desde 2018-04-01.'),
  ('017', 'ANEXO_2', '17', 'Harina, polvo y pellets de pescado', 4.00, 700.00, '>', '2015-01-01',
   'https://orientacion.sunat.gob.pe/apendices-del-sistema-de-detracciones',
   'Apéndice oficial SUNAT consultado el 2026-09-23; tasa vigente desde 2015-01-01.'),
  ('023', 'ANEXO_2', '23', 'Leche', 4.00, 700.00, '>', '2018-06-16',
   'https://orientacion.sunat.gob.pe/apendices-del-sistema-de-detracciones',
   'Apéndice oficial SUNAT consultado el 2026-09-23; tasa vigente desde 2018-06-16.'),
  ('031', 'ANEXO_2', '16', 'Oro gravado con el IGV', 10.00, 700.00, '>', '2015-01-01',
   'https://orientacion.sunat.gob.pe/apendices-del-sistema-de-detracciones',
   'Definición vigente del Anexo 2; no corresponde a minerales de oro del Anexo 1.'),
  ('032', 'ANEXO_2', '32', 'Páprika y frutos de capsicum o pimienta', 10.00, 700.00, '>', '2019-08-01',
   'https://orientacion.sunat.gob.pe/apendices-del-sistema-de-detracciones',
   'Apéndice oficial SUNAT consultado el 2026-09-23; tasa vigente desde 2019-08-01.'),
  ('035', 'ANEXO_2', '20', 'Bienes exonerados del IGV', 1.50, 700.00, '>', '2015-01-01',
   'https://orientacion.sunat.gob.pe/apendices-del-sistema-de-detracciones',
   'Apéndice oficial SUNAT consultado el 2026-09-23; tasa vigente desde 2015-01-01.'),
  ('036', 'ANEXO_2', '11', 'Oro y demás minerales metálicos exonerados del IGV', 1.50, 700.00, '>', '2015-01-01',
   'https://orientacion.sunat.gob.pe/apendices-del-sistema-de-detracciones',
   'Apéndice oficial SUNAT consultado el 2026-09-23; tasa vigente desde 2015-01-01.'),
  ('039', 'ANEXO_2', '9',  'Minerales no metálicos', 10.00, 700.00, '>', '2015-01-01',
   'https://orientacion.sunat.gob.pe/apendices-del-sistema-de-detracciones',
   'Apéndice oficial SUNAT consultado el 2026-09-23; tasa vigente desde 2015-01-01.'),
  ('041', 'ANEXO_2', '41', 'Plomo', 15.00, 700.00, '>', '2019-08-01',
   'https://orientacion.sunat.gob.pe/apendices-del-sistema-de-detracciones',
   'Apéndice oficial SUNAT consultado el 2026-09-23; tasa vigente desde 2019-08-01.'),
  ('012', 'ANEXO_3', '1',  'Intermediación laboral y tercerización', 12.00, 700.00, '>', '2018-04-01',
   'https://orientacion.sunat.gob.pe/apendices-del-sistema-de-detracciones',
   'Apéndice oficial SUNAT consultado el 2026-09-23; tasa vigente desde 2018-04-01.'),
  ('019', 'ANEXO_3', '1',  'Arrendamiento de bienes', 10.00, 700.00, '>', '2015-01-01',
   'https://orientacion.sunat.gob.pe/apendices-del-sistema-de-detracciones',
   'Apéndice oficial SUNAT consultado el 2026-09-23; tasa vigente desde 2015-01-01.'),
  ('020', 'ANEXO_3', '2',  'Mantenimiento y reparación de bienes muebles', 12.00, 700.00, '>', '2018-04-01',
   'https://orientacion.sunat.gob.pe/apendices-del-sistema-de-detracciones',
   'Apéndice oficial SUNAT consultado el 2026-09-23; tasa vigente desde 2018-04-01.'),
  ('021', 'ANEXO_3', '3',  'Movimiento de carga', 10.00, 700.00, '>', '2015-01-01',
   'https://orientacion.sunat.gob.pe/apendices-del-sistema-de-detracciones',
   'Apéndice oficial SUNAT consultado el 2026-09-23; tasa vigente desde 2015-01-01.'),
  ('022', 'ANEXO_3', '5',  'Otros servicios empresariales', 12.00, 700.00, '>', '2018-04-01',
   'https://orientacion.sunat.gob.pe/apendices-del-sistema-de-detracciones',
   'Apéndice oficial SUNAT consultado el 2026-09-23; tasa vigente desde 2018-04-01.'),
  ('024', 'ANEXO_3', '6',  'Comisión mercantil', 10.00, 700.00, '>', '2015-01-01',
   'https://orientacion.sunat.gob.pe/apendices-del-sistema-de-detracciones',
   'Apéndice oficial SUNAT consultado el 2026-09-23; tasa vigente desde 2015-01-01.'),
  ('025', 'ANEXO_3', '7',  'Fabricación de bienes por encargo', 10.00, 700.00, '>', '2015-01-01',
   'https://orientacion.sunat.gob.pe/apendices-del-sistema-de-detracciones',
   'Apéndice oficial SUNAT consultado el 2026-09-23; tasa vigente desde 2015-01-01.'),
  ('026', 'ANEXO_3', '8',  'Servicio de transporte de personas', 10.00, 700.00, '>', '2015-01-01',
   'https://orientacion.sunat.gob.pe/apendices-del-sistema-de-detracciones',
   'Apéndice oficial SUNAT consultado el 2026-09-23; tasa vigente desde 2015-01-01.'),
  ('030', 'ANEXO_3', '9',  'Contratos de construcción', 4.00, 700.00, '>', '2015-01-01',
   'https://orientacion.sunat.gob.pe/apendices-del-sistema-de-detracciones',
   'Apéndice oficial SUNAT consultado el 2026-09-23; tasa vigente desde 2015-01-01.'),
  ('037', 'ANEXO_3', '10', 'Demás servicios gravados con el IGV', 12.00, 700.00, '>', '2018-04-01',
   'https://orientacion.sunat.gob.pe/apendices-del-sistema-de-detracciones',
   'Apéndice oficial SUNAT consultado el 2026-09-23; tasa vigente desde 2018-04-01.'),
  ('044', 'ANEXO_3', '11', 'Servicio de beneficio de minerales metálicos gravado con el IGV', 12.00, 700.00, '>', '2025-04-01',
   'https://www.sunat.gob.pe/legislacion/superin/2025/000086-2025.pdf',
   'RS 086-2025/SUNAT; vigencia desde 2025-04-01.'),
  ('027', 'TRANSPORTE_BIENES', 'transporte_bienes_via_terrestre', 'Transporte de bienes por vía terrestre', 4.00, 400.00, '>', '2006-10-01',
   'https://orientacion.sunat.gob.pe/detracciones-en-el-transporte-de-bienes-por-via-terrestre',
   'RS 073-2006/SUNAT y regla vigente: mayor entre importe de operación y valor referencial; umbral mayor a S/400.'
)
