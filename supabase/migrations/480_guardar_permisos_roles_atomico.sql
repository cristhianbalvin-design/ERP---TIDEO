-- Guarda el lote de permisos de un rol en una unica operacion autorizada.
-- Evita que el cliente dependa de la combinacion de politicas RLS de INSERT y
-- UPDATE durante un UPSERT masivo.
