...
export async function persistirCotizacion(supabase, empresaId, cot) {
  const row = {
    ...
    tipo_documento_id: cot.tipo_documento_id ?? null,
    condiciones_generales_version_id: cot.condiciones_generales_version_id ?? null,
    condiciones_snapshot: cot.condiciones_snapshot ?? null,
...
export async function actualizarCotizacion(supabase, cotId, datos) {
  const allowed = [
    ...
    'tipo_documento_id', 'condiciones_generales_version_id',
    'cond_forma_pago', 'cond_validez', 'cond_penalidad', 'cond_inicio_proyecto',
    'cond_alcance', 'cond_integraciones', 'cond_confidencialidad', 'condiciones_snapshot', 'historial_versiones',
...
export async function persistirOSCliente(supabase, empresaId, osc) {
  const row = {
    ...
    activo_id: osc.activo_id || null,
    cotizacion_id: osc.cotizacion_id || null,
    cotizacion_especial_id: osc.cotizacion_especial_id || null,
    oportunidad_id: osc.oportunidad_id || null,
    sociedad_id: osc.sociedad_id || null,
    numero: osc.numero,
    ...
    fecha_cierre_real: osc.fecha_cierre_real || null,
    sla: osc.sla || null,
...
export async function actualizarHojaCosteoSvc(supabase, hcId, datos) {
  const allowed = [
    ...
    'total_mano_obra', 'total_materiales', 'total_servicios_terceros', 'total_logistica', 'total_activos',
