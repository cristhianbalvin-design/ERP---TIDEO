...
const tenantAdminScreens = [
  ...
  'proveedores','cot_compras','ordenes_compra','ordenes_servicio','recepciones','compras_gastos',
...
export const tickets = [
  {
    ...
    empresa_id: 'emp_001',
    numero: 'TK-0105',
    titulo: 'Motor de ventilacion sin respuesta',
    descripcion: 'Cliente reporta parada de motor de ventilacion en planta principal.',
    tipo: 'averia',
    canal_entrada: 'email',
    estado: 'abierto',
    prioridad: 'critica',
    cuenta_id: 'cta_001',
    cuenta_nombre: 'Minera Andes SAC',
    responsable_id: 'u5',
    responsable_nombre: 'Soporte N2',
    fecha_limite_sla: '2026-04-25T13:00:00-05:00',
    sla_estado: 'vencido',
    fecha_resolucion: null,
    creado_por: 'u2',
    creado_en: '2026-04-25T09:00:00-05:00',
    actualizado_en: '2026-04-25T09:00:00-05:00'
  },
  {
    id: '11111111-1111-4111-8111-111111111104',
    empresa_id: 'emp_001',
    numero: 'TK-0104',
    titulo: 'Calibracion de sensores de presion',
    descripcion: 'Solicitud de soporte por lecturas inestables en sensores de presion.',
    tipo: 'preventivo',
    canal_entrada: 'backoffice',
    estado: 'en_proceso',
    prioridad: 'media',
    cuenta_id: 'cta_002',
    cuenta_nombre: 'Planta Industrial Norte',
    responsable_id: 'u3',
    responsable_nombre: 'Luis Mendoza',
    fecha_limite_sla: '2026-04-28T10:00:00-05:00',
    sla_estado: 'ok',
    fecha_resolucion: null,
    creado_por: 'u2',
    creado_en: '2026-04-26T10:00:00-05:00',
    actualizado_en: '2026-04-26T10:00:00-05:00'
  },
  {
    id: '11111111-1111-4111-8111-111111111103',
    empresa_id: 'emp_001',
    numero: 'TK-0103',
    titulo: 'Revision tablero electrico Q1',
    descripcion: 'Revision preventiva solicitada por el cliente para tablero electrico Q1.',
    tipo: 'preventivo',
    canal_entrada: 'telefono',
    estado: 'resuelto',
    prioridad: 'baja',
    cuenta_id: 'cta_004',
    cuenta_nombre: 'Facilities Lima',
    responsable_id: 'u4',
    responsable_nombre: 'Ana Torres',
    fecha_limite_sla: '2026-04-23T09:00:00-05:00',
    sla_estado: 'ok',
    fecha_resolucion: '2026-04-20T15:40:00-05:00',
    creado_por: 'u3',
    creado_en: '2026-04-20T09:00:00-05:00',
    actualizado_en: '2026-04-20T15:40:00-05:00'
  },
  {
    id: '11111111-1111-4111-8111-111111111102',
    empresa_id: 'emp_001',
    numero: 'TK-0102',
    titulo: 'Falla en variador de frecuencia',
    descripcion: 'Variador con alarmas intermitentes durante arranque de linea.',
    tipo: 'averia',
    canal_entrada: 'email',
    estado: 'en_proceso',
    prioridad: 'alta',
    ...
    cuenta_nombre: 'Minera Andes SAC',
    responsable_id: 'u5',
    responsable_nombre: 'Carlos Reyes',
    fecha_limite_sla: '2026-04-28T08:00:00-05:00',
    sla_estado: 'riesgo',
    fecha_resolucion: null,
    creado_por: 'u2',
    creado_en: '2026-04-27T08:00:00-05:00',
    actualizado_en: '2026-04-27T08:00:00-05:00'
  },
  {
    id: '11111111-1111-4111-8111-111111111101',
    empresa_id: 'emp_001',
    numero: 'TK-0101',
    titulo: 'Consulta garantia de repuestos',
    descripcion: 'Cliente solicita confirmacion de garantia de repuestos instalados.',
    tipo: 'consulta',
    canal_entrada: 'email',
    estado: 'resuelto',
    prioridad: 'baja',
    ...
    cuenta_nombre: 'Planta Industrial Norte',
    responsable_id: 'u2',
    responsable_nombre: 'Carla Meza',
    fecha_limite_sla: '2026-04-25T11:00:00-05:00',
    sla_estado: 'ok',
    fecha_resolucion: '2026-04-22T14:15:00-05:00',
    creado_por: 'u3',
    creado_en: '2026-04-22T11:00:00-05:00',
    actualizado_en: '2026-04-22T14:15:00-05:00'
  },
  {
    id: '11111111-1111-4111-8111-111111111100',
    empresa_id: 'emp_001',
    numero: 'TK-0100',
    titulo: 'Reclamo por atraso en entrega',
    descripcion: 'Cliente reporta demora en entrega comprometida de materiales.',
    tipo: 'reclamo',
    canal_entrada: 'backoffice',
    estado: 'abierto',
    prioridad: 'alta',
    cuenta_id: 'cta_005',
    cuenta_nombre: 'Logistica Altiplano',
    responsable_id: 'u1',
    responsable_nombre: 'Soporte N1',
    fecha_limite_sla: '2026-04-27T16:00:00-05:00',
    sla_estado: 'riesgo',
    fecha_resolucion: null,
    creado_por: 'u2',
    creado_en: '2026-04-26T16:00:00-05:00',
    actualizado_en: '2026-04-26T16:00:00-05:00'
  },
  {
    id: '11111111-1111-4111-8111-111111111099',
    empresa_id: 'emp_001',
    numero: 'TK-0099',
    titulo: 'Solicitud de cotizacion de servicio',
    descripcion: 'Cliente solicita alcance y precio para servicio de mantenimiento menor.',
    tipo: 'consulta',
    canal_entrada: 'email',
    estado: 'resuelto',
    prioridad: 'baja',
    cuenta_id: 'cta_003',
    cuenta_nombre: 'Constructora del Pacifico',
    responsable_id: 'u2',
    responsable_nombre: 'Carla Meza',
    fecha_limite_sla: '2026-04-21T09:00:00-05:00',
    sla_estado: 'ok',
    fecha_resolucion: '2026-04-18T12:00:00-05:00',
    creado_por: 'u2',
    creado_en: '2026-04-18T09:00:00-05:00',
    actualizado_en: '2026-04-18T12:00:00-05:00'
  }
];
...
export const pantallasPermisos = [
  ...
  { key: 'comisiones', modulo: 'RRHH', pantalla: 'Comisiones', acciones: ['ver','crear','editar','aprobar','exportar','finanzas'] },
  { key: 'solicitudes_rrhh', modulo: 'RRHH', pantalla: 'Solicitudes', acciones: ['ver','crear','editar','aprobar','exportar'] },
  ...
  { key: 'liquidaciones_cese', modulo: 'RRHH', pantalla: 'Liquidación por Cese', acciones: ['ver','crear','editar','aprobar','exportar','finanzas'] },
  ...
  { key: 'activos_fijos', modulo: 'Administracion', pantalla: 'Activos Fijos', acciones: ['ver','crear','editar','anular'] },
  { key: 'ventas', modulo: 'Administracion', pantalla: 'Ventas', acciones: ['ver','crear','editar','exportar','finanzas'] },
  { key: 'cxc', modulo: 'Administracion', pantalla: 'Cuentas por Cobrar', acciones: ['ver','crear','editar','anular','aprobar','exportar','finanzas'] },
  { key: 'cxp', modulo: 'Administracion', pantalla: 'Cuentas por Pagar', acciones: ['ver','crear','editar','anular','aprobar','exportar','finanzas'] },
...
export const PLATFORM_PERMISSION_SCREENS = new Set([
  'tenants',
  'planes',
  'metricas_saas',
  'api_keys',
...
export const servicios = [
  ...
  { id: 'SRV-003', familia: 'Instalacion', descripcion: 'Instalacion electrica y CCTV', unidad: 'Proyecto', costo: 12800, precio: 21500, margen: 40, estado: 'activo', facturable: true, precio_incluido: false, detalle: 'Diseño e instalación de sistemas eléctricos industriales y de videovigilancia. Incluye cableado estructurado, montaje de equipos, configuración y pruebas de funcionamiento.', entregables: ['Planos As-Built', 'Manual de usuario del sistema', 'Capacitación al personal (4 horas)', 'Certificado de instalación'] },
  { id: 'SRV-004', familia: 'Consultoria', descripcion: 'Diagnostico operativo y plan de mejora', unidad: 'Informe', costo: 2400, precio: 6800, margen: 65, estado: 'activo', facturable: true, precio_incluido: false, detalle: 'Levantamiento de información del área operativa, análisis de indicadores clave, identificación de brechas y elaboración de plan de mejora con hoja de ruta priorizada.', entregables: ['Informe de diagnóstico ejecutivo', 'Mapa de procesos actual y propuesto', 'Plan de mejora con cronograma', 'Presentación a gerencia'] },
  { id: 'SRV-005', familia: 'Interno', descripcion: 'Inspeccion interna de calidad', unidad: 'Actividad', costo: 420, precio: 0, margen: 0, estado: 'activo', facturable: false, precio_incluido: true, detalle: 'Inspección interna del área de calidad. Actividad no facturable al cliente; se incluye como parte del alcance del servicio principal.', entregables: ['Lista de verificación completada', 'Registro fotográfico'] }
];
